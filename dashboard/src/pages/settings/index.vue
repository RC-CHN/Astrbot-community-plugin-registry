...
const editableItems: ConfigItem[] = [
  ...
  },
  {
    ...
    input: 'boolean',
    scope: '扫描时生效',
    description: '启用后通过 clamd TCP INSTREAM 扫描插件压缩包。',
  },
  {
    key: 'CLAMAV_HOST',
    label: 'ClamAV Host',
  ...
  },
  {
    ...
    input: 'number',
    scope: '扫描时生效',
    description: 'clamd TCP 端口，默认 3310。',
  },
  {
    ...
    input: 'number',
    scope: '扫描时生效',
    description: '单次 ClamAV 扫描最长等待秒数。',
  },
  {
    ...
    input: 'number',
    scope: '扫描时生效',
    description: 'clamd INSTREAM 上传分块大小，单位字节。',
  },
  {
    ...
    input: 'number',
    scope: '扫描时生效',
    description: '允许发送给 clamd 的最大插件包大小，单位字节。',
  },
  {
